# 1 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c"
...
# 1 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
...
# 2 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
...
# 3 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
...
# 4 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
...
Action()
{
	...
	lr_start_transaction("UC3_RemoveTicket");
		...
		lr_start_transaction("login");
			...
			web_reg_find("Text=Error","Fail=Found","LAST");
			web_reg_find("Text=Welcome, <b>007</b>, to the Web Tours reservation pages.", "LAST");
		...
		lr_end_transaction("removing_ticket",2);
	...
	lr_end_transaction("UC3_RemoveTicket", 2);

	return 0;
}
# 5 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
...
# 6 "d:\\loadrunner\\lrprojects\\uc3_removeticket\\\\combined_UC3_RemoveTicket.c" 2
